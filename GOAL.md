...
| Field | Value |
| --- | --- |
| Status | ACTIVE — M0 complete; M1 result 1 merged; result 2 independently approved locally |
...
Status：**ACTIVE** — result 1 of 7 is independently `APPROVED` and merged by PR #24 at `main@cd1a936`; result 2 of 7 is independently `APPROVED` locally at `codex/25-storyboard-planning@bb8e497`; results 3–7 remain pending and unauthorized without their own Task Contracts.
